"""
Django settings for school_archive project.
...
SECRET_KEY = 'django-insecure-odu)ygesrlc5@2l1f@$7i7p^t_papag#a1%#q#!x-@a$*7^p#s'
...
ROOT_URLCONF = 'school_archive.urls'
...
WSGI_APPLICATION = 'school_archive.wsgi.application'
...
# УБЕРИТЕ ЭТУ СТРОКУ:
# AUTH_USER_MODEL = 'media_archive.CustomUser'
